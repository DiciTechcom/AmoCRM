...
var DomainResponseHandler = /*#__PURE__*/function (_ResponseHandler) {
  _inherits(DomainResponseHandler, _ResponseHandler);

  var _super = _createSuper(DomainResponseHandler);
  ...
  _createClass(DomainResponseHandler, [{
    ...
    value: function toJSON(options) {
      ...
      try {
        ...
        throw Error("cannot parse JSON: ".concat(resonseData));
      }
...
var _default = DomainResponseHandler;
